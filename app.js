...
const covertPlayerDbObjectToResponseObject = (dbObject) => {
  return {
...
const covertMatchDetailsDbObjectToResponseObject = (dbObject) => {
  return {
...
app.get("/players/", async (request, response) => {
  ...
  response.send(
    playersArray.map((eachPlayer) => 
     covertPlayerDbObjectToResponseObject(eachPlayer)
  );
});
